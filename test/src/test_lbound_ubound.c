...
void should_get_bounds_of_one_dimension_array() {
  ...
  */
  ...
  assert_equals_I64_I64(3 - 1, ubound(&array[2]));
}

void should_get_bounds_of_two_dimension_array() {
  // Simulate how JCC arranges variables in memory
  int64_t array[9] = { 2, 3, 2, 10, 20, 30, 10, 20, 30 };
  /*
  ...
  */
  ...
  assert_equals_I64_I64(3 - 1, ubound_I64(&array[3], 1));
  assert_equals_I64_I64(0,     lbound_I64(&array[3], 2));
  assert_equals_I64_I64(2 - 1, ubound_I64(&array[3], 2));
}

void should_get_bounds_when_option_base_is_1() {
  // Simulate how JCC arranges variables in memory
  int64_t array[11] = { 4, 2, 2, 10, 20, 30, 40, 50, 60, 70, 80 };
  option_base(1);
  assert_equals_I64_I64(1,     lbound_I64(&array[3], 1));
  assert_equals_I64_I64(2 - 1, ubound_I64(&array[3], 1));
  assert_equals_I64_I64(1,     lbound_I64(&array[3], 2));
  assert_equals_I64_I64(4 - 1, ubound_I64(&array[3], 2));
}
